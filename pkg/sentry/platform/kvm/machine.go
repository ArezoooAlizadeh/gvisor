...
var (
	...
	hostExitCounter = metric.MustCreateNewKvmProfileUint64Metric(
	...
	userExitCounter = metric.MustCreateNewKvmProfileUint64Metric(
	...
	interruptCounter = metric.MustCreateNewKvmProfileUint64Metric(
	...
	mmapCallCounter = metric.MustCreateNewKvmProfileUint64Metric(
	...
	getVCPUCounter = metric.MustCreateNewKvmProfileUint64Metric(
	...
	asInvalidateDuration = metric.MustCreateNewKvmProfileTimerMetric("/kvm/address_space_invalidate",
